...
Die Jugendliche L wandte sich mit einer Fragestellung an, die mit einem ambivalenten emotionalen Zustand verbunden war. Einerseits zeigte sich eine ausgeprägte Erschöpfung durch den alltäglichen Routineablauf sowie ein Bedürfnis nach neuen, interessanten Erfahrungen; andererseits waren Ängste vor dem Scheitern und Unsicherheiten im Zusammenhang mit dem Ausprobieren neuer Tätigkeitsformen und Selbstverwirklichung vorhanden.
Im Rahmen der Arbeit wurde eine Intervention vorgeschlagen, die auf eine behutsame Erweiterung der Komfortzone durch die Verbindung von Neuartigkeit und Aktivität abzielte. Als Arbeitsform wurde eine kreative Aufgabe gewählt – die Entwicklung eines Sounddesigns für ein eigenes Spiel, kombiniert mit einem aktiven Spaziergang im urbanen Raum und der gezielten Suche nach Klangmaterial in der Umgebung. Diese Tätigkeit verband forschende Elemente, körperliche Aktivität und kreative Entscheidungsfreiheit und ermöglichte so ein ausgewogenes Verhältnis zwischen Struktur und Offenheit innerhalb eines für die Jugendliche sicheren Rahmens.
Während des Spaziergangs konnte eine Verschiebung des Aufmerksamkeitsfokus beobachtet werden: Die städtische Umgebung wurde nicht mehr als vertraut und monoton wahrgenommen, sondern als ein von Klängen und Ereignissen geprägter Raum. Gewöhnliche Objekte und Situationen erhielten durch die Fokussierung auf ihre auditiven Eigenschaften eine neue Bedeutung. Zentrale Fragen waren dabei, welche Klänge im Raum vorhanden sind und wie diese im spielerischen Kontext eingesetzt werden können.
Als Spielform wählte die Jugendliche das Spiel Ping Pong. Diese Entscheidung war durch die Einfachheit, die vertraute Spielmechanik und die klare Struktur des Spiels motiviert, was dazu beitrug, die mit Neuartigkeit verbundene Angst zu reduzieren und gleichzeitig Raum für experimentelle Arbeit mit Klangmaterial zu schaffen.
Zur Aufnahme der Klänge wurden zwei kabellose RØDE-Mikrofone verwendet: Ein Mikrofon fungierte als Empfänger und war mit einem mobilen Endgerät verbunden, das zweite wurde als Sender zur Aufnahme von Umgebungsgeräuschen eingesetzt.
